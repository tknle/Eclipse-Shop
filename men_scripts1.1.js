var menimgs = [
  {
    caption: 'Dragon Balls T-shirt',
    alt: 'B1-01',
    src: 'images/men-ts2.jpg',
    text: 'Available size: S M L XL',
    text1: 'Color:White/Grey/Black/Green',
    text2:  'Price:$25.00 CAD'
  },
  {
    caption: 'V-neck T-shirt',
    alt: 'B1-02',
    src: 'images/men-ts3.jpg',
    text: 'Available size: M',
    text1:'Color:White/Grey',
    text2:'Price:$15.00 CAD'
  },
  {
    caption: 'Blue Man T-shirt',
    alt: 'B1-03',
    src: 'images/men-ts7.jpg',
    text: 'Available size: XS S M L XL XXL',
    text1: 'Color:Black',
    text2:'Price:$25.00 CAD'
  },
  {
    caption: 'Roundneck T-shirt',
    alt: 'B1-05',
    src: 'images/ts3.jpg',
    text: 'Available size: XS',
    text1: 'Color:White/Grey/Black/Yellow',
    text2: 'Price: $10.00 CAD'
  },
  {
    caption: 'Thraser T-shirt',
    alt: 'A1-04',
    src: 'images/men-ts6.jpg',
  ...
  },
  {
    caption: 'Roundneck T-shirt',
    alt: 'A1-04',
    src: 'images/men-ts4.jpg',
    text: 'Available size: S M L',
    text1: 'Color:Grey/Black',
    text2: 'Price: $15.00 CAD'
  },
  {
    caption: 'Tommy Jean T-shirt',
    alt: 'A1-07',
    src: 'images/men-ts8.jpg',
  ...
  },
  {
    caption: 'Tommy Jean T-shirt',
    alt: 'A1-04',
    src: 'images/men-ts1.jpg',
    text: 'Available size: XS S L XL',
    text1:'Color:White/Grey/Black/Red/Blue/Tan',
    text2: 'Price: $30.00 CAD'
  }
];
...
window.onload = function() {
 ...
 //load img from 1 to last element in the array, make a loop, the first if
  ...
  // each image in a div.
function loadImgMen() {
  var x = document.querySelector('.outputimgmen'); //. is a class
